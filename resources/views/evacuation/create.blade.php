    ...
    <form action="{{ route('evacuation.store') }}" method="POST">
      ...
      <div class="row">
        <div class="col-md-4 mb-3">
          ...
          <input type="number" name="current_occupancy" min="0" class="form-control" value="{{ old('current_occupancy', 0) }}">
          <small class="text-muted">Headcount physically inside</small>
        </div>
        <div class="col-md-4 mb-3">
          <label class="form-label fw-semibold">Families Registered</label>
          <input type="number" name="families_registered" min="0" class="form-control" value="{{ old('families_registered', 0) }}">
          <small class="text-muted">Pre-registered families count</small>
        </div>
        <div class="col-md-4 mb-3">
          <label class="form-label fw-semibold">Medical Needs Flagged</label>
          <input type="number" name="medical_needs_count" min="0" class="form-control" value="{{ old('medical_needs_count', 0) }}">
